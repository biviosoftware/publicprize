...
app.config(function($routeProvider) {
    ...
    $routeProvider
        ...
        .when('/enter-the-challenge',
            route(
                'enter-the-challenge',
                'HomeController as enterTheChallenge'))
        .when(
            '/event-voting',
            route(
                'event-voting',
...
app.directive('contestPage', function ($location) {
    return {
        ...
        transclude: true,
        template: [
            '<div class="pp-contest">',
              '<img class="pp-jumbo-bg" src="/static/img/evc17-header-1200x377.png" />',
    ...
    return {
        ...
        template: [
            ...
            '<ul class="pp-menu nav-justified">',
              '<li data-ng-class="{\'pp-menu-active\': isSelected(\'about\') }"><a class="btn btn-default" href="#/about">About</a></li>',
              '<li data-ng-if="contestInfo().isNominating" data-ng-class="{\'pp-menu-active\': isSelected(\'enter-the-challenge\') || isSelected(\'submit-nominee\') }"><a class="btn btn-default" href="#/enter-the-challenge">Enter the Challenge</a></li>',
